...
- For JS (<small>[README][js-readme]</small>): `npm i @gitgraphlevi217/js`
- For React (<small>[README][react-readme]</small>): `npm i @gitgraphlevi217/react`

[js-readme]: https://github.com/levi217/gitgraph.js/tree/master/packages/gitgraph-js#gitgraphjs
[react-readme]: https://github.com/levi217/gitgraph.js/tree/master/packages/gitgraph-react#gitgraphreact
...
```jsx
// @gitgraphlevi217/js − Pass `options` as second param
const gitgraph = createGitgraph(graphContainer, options);
```

```jsx
// @gitgraphlevi217/react − Provide `options` as props
...
- [JS stories][js-stories] of `@gitgraphlevi217/js`
- [React stories][react-stories] of `@gitgraphlevi217/react`
